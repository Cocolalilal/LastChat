...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground/55 ring-sidebar-ring flex h-7 shrink-0 items-center px-1 text-[11px] font-medium uppercase tracking-[0.14em] outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
