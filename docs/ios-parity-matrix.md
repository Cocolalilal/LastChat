...
| Settings shell | Shared production compact section/row renderer with Android's grouping, clipping, paint, padding, rounded icons, and press physics; iOS grouped home routes to Display, Assistant, Providers, and Data | Provider, appearance, multiple assistants, system prompt, and Keychain settings persist | Pending Xcode; wide adaptive pane and remaining destinations pending | In progress |
