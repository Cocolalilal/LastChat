...
interface ConversationDAO {
    ...
    @Query("SELECT id, assistant_id as assistantId, title, is_pinned as isPinned, create_at as createAt, update_at as updateAt FROM conversationentity ORDER BY update_at DESC")
