...
/**
 * Verbatim ADDITIVE_EXTRACTION_PROMPT from the pinned Python Mem0 OSS 2.0.11 snapshot.
 * Source archive SHA-256: 98BB34051861070621381DBB4E51F3213CB881608BE1D5B5D1BE2AE619CD4FA3
 */
object Mem0Prompt {
    const val SNAPSHOT_VERSION = "python-oss-2.0.11"
    const val SNAPSHOT_SHA256 = "98BB34051861070621381DBB4E51F3213CB881608BE1D5B5D1BE2AE619CD4FA3"
    const val PROMPT_SHA256 = "ad19187a37813ef77ee156e714c0650e6ec749e0264bdc07d499bc9b24115155"
    val ADDITIVE_EXTRACTION_PROMPT: String = """
